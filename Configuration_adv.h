...
#define AUTOTEMP
  ...
  #define AUTOTEMP_PROPORTIONAL
    ...
    #define AUTOTEMP_FACTOR_P 1.0 // Apply this F parameter by default (overridden by M104/M109 F)
  #endif
#endif
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_LIMIT       37     // Maximum number of sorted items (10-256). Costs 27 bytes each.
