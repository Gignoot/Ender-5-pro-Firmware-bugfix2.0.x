...
#define STRING_CONFIG_H_AUTHOR "(GGFab for Ender-5 Pro)" // Who made the changes.
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.039  // (mm) Distance from real junction edge
...
#define PREHEAT_2_FAN_SPEED    52 // Value from 0 to 255
